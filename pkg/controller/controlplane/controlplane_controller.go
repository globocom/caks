...
import (
	...
	cacksv1alpha1 "github.com/globocom/caks/pkg/apis/cacks/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &cacksv1alpha1.ControlPlane{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &cacksv1alpha1.ControlPlane{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileControlPlane) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &cacksv1alpha1.ControlPlane{}
...
func newPodForCR(cr *cacksv1alpha1.ControlPlane) *corev1.Pod {
